%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Olfati Saber parameters Vignesh Edit
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Vignesh Data
p_swarm.sector_angle = 170*pi/180;
p_swarm.vignesh_KPmax=0.1;
p_swarm.vignesh_KPmin=0.1;
p_swarm.vignesh_vmax=5;
p_swarm.vignesh_vmin=1;
p_swarm.vignesh_omega_max=2;