classdef Swarm < handle
    ...
    methods
        ...
        function [vel_commands, collisions] = update_command(self, p_swarm, r_coll, dt)
            ...
            elseif self.algorithm == "vignesh"
                [vel_commands,collisions] = self.compute_vel_vignesh(p_swarm,r_coll,dt);
            elseif self.algorithm == "olfati_swamy"
                [vel_commands,collisions] = self.compute_vel_olfati_swamy(p_swarm,r_coll,dt);
            end
